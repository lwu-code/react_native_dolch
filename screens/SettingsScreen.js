...
const SettingsScreen = inject("GameStore")(
  observer(
    class SettingsScreen extends React.Component {
      static navigationOptions = {
        title: "Dolch Sight Words Settings"
      };
        ...
        return (
          <View style={styles.container}>
            <View style={styles.section}>
              <Text>
                Field size ({fieldSize}x{fieldSize}):
              </Text>
              <Slider
            ...
            <View style={styles.section}>
              ...
              <View style={styles.inputWithButton}>
                ...
                <View style={styles.buttonWrapper}>
                  <Button
                    title="Set to Garrett"
                    onPress={() => GameStore.setPlayerTwoName("Garrett")}
                  />
                </View>
              </View>
            </View>
            ...
            <View style={styles.section}>
              <Text>Garrett turn limit ({aiTurnLimit}s):</Text>
              <Slider
